...
import {
  Alert, Box, Button, CircularProgress, Dialog, DialogContent, MenuItem,
...
import {
  TituloDialogo, cardSx, useDialogoTelaCheia, useTelaDesktop
} from '../ui'
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: TOV.canvas }}>
      ...
      <Dialog open={!!selecionada} onClose={() => setSelecionada(null)} maxWidth="sm" fullWidth fullScreen={telaCheia}>
        {selecionada && (
          <>
            <TituloDialogo onFechar={() => setSelecionada(null)}>{selecionada.materia_nome}</TituloDialogo>
            <DialogContent>
