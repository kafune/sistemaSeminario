...
export default function Login() {
  ...
  return (
    <Box component="main" sx={{ display: 'flex', minHeight: '100vh', bgcolor: TOV.canvas }}>
      {/* A composição de duas faixas tem teto: acima disso o painel virava uma
          tira escura num mar de canvas, com o cartão flutuando no meio. */}
      <Box sx={{ display: 'flex', flex: '1 1 auto', width: '100%', maxWidth: 1400, mx: 'auto' }}>
        {/* Painel institucional (esconde no mobile) */}
        <Box
          sx={{
            flex: '0 0 min(46vw, 680px)', maxWidth: 680, bgcolor: TOV.graphite, color: TOV.onDark,
        ...
        >
          ...
          <Box sx={{ position: 'relative' }}>
            ...
            <Typography component="h2" variant="h1" sx={{ fontSize: { md: TOV.type.display, lg: TOV.type.heroLg }, color: TOV.onDark, maxWidth: 560 }}>
